      ...
      <div class="footer__wrapper">
        ...
        <div class="footer__col2">
          ...
          <ol class="footer__text">
            ...
            <li>
              <a href="http://localhost/workspace/Rstaurant%20Projet/booking.php/about.php">About Us</a>
            </li>
            <li>
              <a href="http://localhost/workspace/Rstaurant%20Projet/booking.php/contact.php">contact Us</a>
            </li>
            <li>
